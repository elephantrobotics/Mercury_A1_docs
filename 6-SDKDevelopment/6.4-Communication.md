...
* Controls the specified motor to move a specified distance in the specified direction. It will pause/stop upon receiving a pause/stop command.
    ...
    Instruction Length: 6 Function Code: 0x06
...
* Zeroing is required before setting. Read the current direction first, then set.<br>
...
* Used to modify the velocity and acceleration of the position loop velocity fusion interface.<br>
...
- Only supports Pro force control grippers and three-finger grippers<br>

- Public interface; other specific function interfaces: Force control gripper: [Force Control Gripper Communication Protocol](https://docs.elephantrobotics.com/docs/myGripper-F100-en/5-BasicApplication/5.2.html); Three-finger: [Three-finger Communication Protocol](https://docs.elephantrobotics.com/docs/myGripper-en/5-BasicApplication/5-BasicApplication.html)<br>

- Force control IO: 1 bottom 2 high: On, 1 high 2 low: Off; After using the IO, the 485 needs to change the IO to the same state, 1 and 2 are both high or both low.<br>
...
- Only supports Pro force control gripper and three-finger gripper<br>
